    ...
    >
      <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
        <div class="modal-content">
          <BaseBlock title="Agregar Categoria" transparent class="mb-0">
            <template #options>
              <button
                type="button"
            ...
            <template #content>
              <div class="block-content fs-sm">
                <div class="form-group">
                  <label for="modal-block-small-name">Nombre Categoria:</label>
                  <input
                    type="text"
                ...
                <div class="form-group">
                  <label for="modal-block-small-equipo">Seleccione una imagen:</label>
                  <input
                    type="file"
                    class="form-control mb-3 mt-3"
